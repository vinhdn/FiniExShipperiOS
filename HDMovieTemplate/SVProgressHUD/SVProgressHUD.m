...
@property (nonatomic, strong, readonly) CustomLabel *stringLabel;
...
- (NSTimeInterval)displayDurationForString:(NSString*)string {
        NSLog(@"value string: %@ - %f",string,(float)string.length*0.06 + 0.3);
...
- (CustomLabel *)stringLabel {
    if (stringLabel == nil) {
        stringLabel = [[CustomLabel alloc] initWithFrame:CGRectZero];
